...
class StringRect extends FlxSpriteGroup {
    ...
    public function new(X:Float, Y:Float, point:Option = null)
    {
        ...
        downRect.antialiasing = ClientPrefs.antialiasing;
        add(downRect);
        ...
        upRect.antialiasing = ClientPrefs.antialiasing;
        add(upRect);
        ...
        disText.antialiasing = ClientPrefs.antialiasing;  		
        add(disText);
...
class OptionCata extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, _title:String)
	{
        ...
        specRect.alpha = 0;
        specRect.scale.y = 0;
        specRect.antialiasing = ClientPrefs.antialiasing;	
        add(specRect);
	}
