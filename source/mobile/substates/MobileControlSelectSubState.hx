...
class MobileControlSelectSubState extends MusicBeatSubstate
{
    ...
    override public function create():Void
    {
        ...
        vpad = new FlxVirtualPad(RIGHT_FULL, controlExtend, 0.75, ClientPrefs.antialiasing);
        vpad.alpha = 0;
        vpad.cameras = [ui];
        add(vpad);
    ...
    function changeSelection(change:Int = 0)
    {
        ...
        switch (daChoice)
        {
            case 'Pad-Right':
                ...
                remove(vpad);
                vpad = new FlxVirtualPad(RIGHT_FULL, NONE, 0.75, ClientPrefs.antialiasing);
                add(vpad);
                loadcustom(false);
            case 'Pad-Left':
                reset.visible = false;
                keyboard.visible = true;
                remove(vpad);
                vpad = new FlxVirtualPad(FULL, NONE, 0.75, ClientPrefs.antialiasing);
                add(vpad);
                loadcustom(false);
            case 'Pad-Custom':
                reset.visible = true;
            ...
            case 'Duo':
                ...
                keyboard.visible = true;
                remove(vpad);
                vpad = new FlxVirtualPad(DUO, NONE, 0.75, ClientPrefs.antialiasing);
                add(vpad);
                loadcustom(false);
            case 'Hitbox':
                reset.visible = false;
