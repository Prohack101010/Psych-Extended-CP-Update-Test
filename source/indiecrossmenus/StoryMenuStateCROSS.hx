...
class StoryMenuStateCROSS extends MusicBeatState
{
	...
	override function create()
	{
		...
		actualBG.antialiasing = ClientPrefs.antialiasing;
		add(actualBG);
		...
		gamingSands.x = -13;
		gamingSands.y = -41;
		gamingSands.antialiasing = ClientPrefs.antialiasing;
		add(gamingSands);
		...
		bendoBG.antialiasing = ClientPrefs.antialiasing;
		...
		leftpanel.antialiasing = ClientPrefs.antialiasing;
		add(leftpanel);
		...
		gamingCup.x = 760;
		gamingCup.y = 233;
		gamingCup.antialiasing = ClientPrefs.antialiasing;
		add(gamingCup);
		...
		bottompannel.antialiasing = ClientPrefs.antialiasing;
		add(bottompannel);
		...
		diffOrigX = -2;
		diffifSpr.y = 128;
		diffifSpr.antialiasing = ClientPrefs.antialiasing;
		add(diffifSpr);
		...
		diffmechSpr.antialiasing = ClientPrefs.antialiasing;
		add(diffmechSpr);
		...
		storyPanel.antialiasing = ClientPrefs.antialiasing;
		add(storyPanel);
		...
		for (i in 0...optionShit.length)
		{
			...
			flash.antialiasing = ClientPrefs.antialiasing;
			flash.updateHitbox();
		}
		...
		cupTea.updateHitbox();
		cupTea.screenCenter();
		cupTea.antialiasing = ClientPrefs.antialiasing;
